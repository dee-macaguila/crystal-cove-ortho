          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-4">
              <Image
                ...
                priority
              />
              <h1 className="text-2xl md:text-3xl font-normal italic text-blue-700 font-moontime">Dr. Cynthia Wong Orthodontics</h1>
            </div>

            {/* Primary Nav */}
            <nav className="hidden lg:flex items-center gap-6 text-sm md:text-base">
              <a href="#about" className="text-slate-700 hover:text-blue-700 transition-colors leading-tight">Our Practice</a>
              <a href="#about" className="flex items-center gap-1 text-slate-700 hover:text-blue-700 transition-colors leading-tight">
                <span>About Us</span>
                <ChevronDown className="w-3 h-3" />
              </a>
              <a href="#services" className="flex items-center gap-1 text-slate-700 hover:text-blue-700 transition-colors leading-tight">
                <span>Our Orthodontic Care</span>
                <ChevronDown className="w-3 h-3" />
              </a>
              <a href="#resources" className="flex items-center gap-1 text-slate-700 hover:text-blue-700 transition-colors leading-tight">
                <span>Patient Resources</span>
                <ChevronDown className="w-3 h-3" />
              </a>
              <a href="#testimonials" className="text-slate-700 hover:text-blue-700 transition-colors leading-tight">Testimonials</a>
              <a href="#contact" className="text-slate-700 hover:text-blue-700 transition-colors leading-tight">Contact Us</a>
              <a href="#contact" className="inline-flex items-center rounded-md bg-blue-600 text-white px-3 py-1.5 text-sm font-medium hover:bg-blue-700 transition-colors leading-tight">Appointment Request</a>
              <a href="#services" className="text-slate-700 hover:text-blue-700 transition-colors leading-tight">SureSmile</a>
            </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#about" className="text-blue-200 hover:text-white transition-colors">Our Practice</a></li>
